...
async function listModels() {
  ...
  try {
    ...
    if (!response.ok) {
      ...
      console.error('5. Copy the new key and update server/.env file');
    ...
    if (data.models && data.models.length > 0) {
      ...
      const recommended = flashModel || proModel || generateModels[0];

      console.log(`\n✨ RECOMMENDED MODEL: ${recommended.name}`);
      console.log(`\n📝 Update server/services/ai.js line 8 to:`);
