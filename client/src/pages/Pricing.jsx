      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-6 sm:mb-8 lg:mb-10 relative px-4">
          ...
          <div className="relative">
            <div className="inline-flex items-center gap-1.5 sm:gap-2 bg-gradient-to-r from-indigo-100 to-purple-100 text-indigo-700 px-2.5 sm:px-4 py-1 sm:py-1.5 rounded-full text-xs font-bold mb-2 sm:mb-3 shadow-sm border border-indigo-200">
              ...
              >
                ...
                {plan.popular && (
                  <div className="absolute -top-2.5 left-1/2 transform -translate-x-1/2">
                    <div className="bg-gradient-to-r from-indigo-600 to-purple-600 text-white px-2.5 py-0.5 rounded-full text-[10px] font-bold shadow-lg flex items-center gap-1 animate-pulse">
                ...
                <div className="mb-3 sm:mb-4">
                  ...
                  {plan.name === 'Free' && (
                    <p className="text-[10px] sm:text-xs text-gray-500 mt-0.5">Forever free</p>
                  )}
                </div>
                ...
                <button
                  ...
                  className={`w-full py-2 sm:py-2.5 rounded-lg text-xs sm:text-sm font-bold transition-all duration-300 flex items-center justify-center gap-1.5 ${
                    plan.name === 'Pro'
                ...
                >
                  {plan.name === 'Pro' && <Crown className="w-3.5 h-3.5 sm:w-4 sm:h-4" />}
                  {plan.popular && <TrendingUp className="w-3.5 h-3.5 sm:w-4 sm:h-4" />}
                  <span>{plan.cta}</span>
                </button>
              </div>
            );
        ...
        <div className="mt-8 sm:mt-12 text-center px-4">
          <p className="text-xs sm:text-sm text-gray-600 mb-3 sm:mb-4">Trusted by professionals worldwide</p>
        ...
        <div className="mt-12 sm:mt-16 max-w-3xl mx-auto px-4">
          ...
          <div className="space-y-3 sm:space-y-4">
            <div className="bg-white rounded-lg sm:rounded-xl p-4 sm:p-5 shadow-md border border-gray-200">
              <h3 className="text-sm sm:text-base font-bold text-gray-900 mb-1.5 sm:mb-2">Can I switch plans later?</h3>
            ...
            <div className="bg-white rounded-lg sm:rounded-xl p-4 sm:p-5 shadow-md border border-gray-200">
              <h3 className="text-sm sm:text-base font-bold text-gray-900 mb-1.5 sm:mb-2">What payment methods do you accept?</h3>
              <p className="text-xs sm:text-sm text-gray-600">We accept payments through eSewa, Nepal's most trusted digital wallet.</p>
            </div>
            <div className="bg-white rounded-lg sm:rounded-xl p-4 sm:p-5 shadow-md border border-gray-200">
              <h3 className="text-sm sm:text-base font-bold text-gray-900 mb-1.5 sm:mb-2">Can I cancel my subscription?</h3>
              <p className="text-xs sm:text-sm text-gray-600">Yes, you can cancel anytime. You'll continue to have access until the end of your billing period.</p>
            </div>
          </div>
        </div>
      </div>
